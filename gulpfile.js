...
gulp.task('watch', ['sass', 'css-libs', 'js', 'js-libs', 'pug', 'html', 'browser-sync'], function(){
...
gulp.task('build', ['removedist', 'buildhtml', 'imagemin', 'sass', 'css-libs', 'js', 'js-libs', 'pug', 'html'], function(){
